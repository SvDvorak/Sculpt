...
public class Triangulator
{
    ...
    public int[] Triangulate(Vector3[] points)
    {
    ...
    private float Area()
    {
        ...
        {
            Vector3 pval = _points[p];
            Vector3 qval = _points[q];
    ...
    {
        int p;
        Vector3 A = _points[V[u]];
        Vector3 B = _points[V[v]];
        Vector3 C = _points[V[w]];
